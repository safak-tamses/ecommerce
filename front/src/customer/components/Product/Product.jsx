...
export default function Product() {
  ...
  const pageNumberValue = searchParamms.get("page") || 1;
  const stockValue = searchParamms.get("stock");
  const pageSizeValue = searchParamms.get("pageSize");
  ...
  const handleFilter = (value, sectionId) => {
    ...
    console.log("fenasikerim ", products);
  };
  ...
  const handlePageSize = (event, value) => {
    const searchParamms = new URLSearchParams(location.search);
    searchParamms.set("page_size", value);
    const query = searchParamms.toString;
    navigate({ search: `?${query}` });
  };
  ...
  useEffect(() => {
    ...
    const data = {
      ...
      pageSize: 10,
      stockValue,
      firstCategory: param1,
      secondCategory: param2,
      thirdCategory: param3,
      sort : sortValue
    };
    console.log(data);
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
                    ...
                    <div className="py-1 w-full">
                      {sortOptions.map((option) => (
                        <Menu.Item key={option.name}>
                          {({ active }) => (
                            /* TODO */
                            /* Bu kısımda fiyatları düşükten pahalıya veya pahalıdan düşüğe sıralama yapıcam */
                            <button
                              ...
                              className={classNames(
                                ...
                                active ? "bg-gray-100" : "",
                                "block px-4 py-2 text-sm text-left hover:text-orange-500"
                              )}
                            >
                              {option.name}
                            </button>
          ...
          <section aria-labelledby="products-heading" className="pb-12 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-16 gap-y-10 lg:grid-cols-6">
              {/* Filters */}
              <div>
              ...
              {/* Product grid */}
              <div className="lg:col-span-5 w-full pl-8">
                <div className="flex flex-wrap justify-start bg-white py-2">
